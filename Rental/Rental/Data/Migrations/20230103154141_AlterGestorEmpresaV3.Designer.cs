...
namespace Rental.Data.Migrations
{
    ...
    [Migration("20230103154141_AlterGestorEmpresaV3")]
    partial class AlterGestorEmpresaV3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rental.Models.Empresa", b =>
                {
                    ...
                    b.HasIndex("GestorId")
                        .IsUnique()
                        .HasFilter("[GestorId] IS NOT NULL");
            ...
            modelBuilder.Entity("Rental.Models.Empresa", b =>
                {
                    b.HasOne("Rental.Models.ApplicationUser", "gestor")
                        .WithOne()
                        .HasForeignKey("Rental.Models.Empresa", "GestorId");
